...
namespace Mobile.Views.Warning
{
    ...
    public partial class Warning : ContentPage
    {
        ...
        public Warning()
        {
            ...
            btnAdd.Clicked += CreateAlert_OnClicked;
            CurrentPage = 1;
        ...
        async void OnItemSelected(object sender, SelectedItemChangedEventArgs args)
        {
            ...
            if (item == null)
                return;
            await Navigation.PushAsync(new WarningDetail(item));
        ...
        private async void CreateAlert_OnClicked(object sender, EventArgs e)
        {
