...
void xamarin_register_assemblies_impl ()
{
	...
	xamarin_open_and_register ("TEditor.dll", &exception_gchandle);
	xamarin_process_managed_exception_gchandle (exception_gchandle);
	...
	xamarin_process_managed_exception_gchandle (exception_gchandle);
	xamarin_open_and_register ("FormsPlugin.Iconize.iOS.dll", &exception_gchandle);
	xamarin_process_managed_exception_gchandle (exception_gchandle);
	xamarin_open_and_register ("Plugin.Iconize.iOS.dll", &exception_gchandle);
	xamarin_process_managed_exception_gchandle (exception_gchandle);
	xamarin_open_and_register ("Microsoft.Identity.Client.Platform.dll", &exception_gchandle);
	xamarin_process_managed_exception_gchandle (exception_gchandle);
